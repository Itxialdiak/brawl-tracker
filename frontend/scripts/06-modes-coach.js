...
function renderHighlights(h) {
  $("highlights").innerHTML = [
    ...
    hlCard("⚠️", "Peor win rate", h.worst_brawler, "brawler", (v) => `${v.winrate}% · ${v.total}p`, "worst"),
...
const HL_CATS = {
  ...
  worst: { title: "Peor win rate", sub: "Tus brawlers por win rate puro (mín. 3 partidas)", url: "/api/winrate?by=brawler", kind: "brawler", min: 3, sort: (a, b) => a.winrate - b.winrate, val: (v) => `${v.winrate}% · ${v.total}p`, color: true },
